...
class CourtDetector:
    ...
    def detect(self, frame, verbose=0):
        ...
        #display_lines_on_frame(frame,horizontal_lines,vertical_lines)
    ...
    def find_lines_location(self):
        ...
        p =  np.round(np.squeeze(cv2.perspectiveTransform(p,self.court_warp_matrix[-1]))).astype(int)
        print(p)
        ...
        #if self.verbose:
        display_lines_on_frame(self.frame.copy(), [self.baseline_top, self.baseline_bottom, self.baseline_top_inner,
...
if __name__ == '__main__':
    filename = 'D:/EFREI/project/Badminton_Project/data/images/7.jpg'
